...
class ComentariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comentario" do
    assert_difference("Comentario.count") do
      post comentarios_url, params: { comentario: { calificacion: @comentario.calificacion, contenido: @comentario.contenido, producto_id: @comentario.producto_id, usuario_id: @comentario.usuario_id } }
    end
  ...
  test "should update comentario" do
    patch comentario_url(@comentario), params: { comentario: { calificacion: @comentario.calificacion, contenido: @comentario.contenido, producto_id: @comentario.producto_id, usuario_id: @comentario.usuario_id } }
