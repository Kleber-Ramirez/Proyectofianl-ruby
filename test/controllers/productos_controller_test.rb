...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference("Producto.count") do
      post productos_url, params: { producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, fecha_agregado: @producto.fecha_agregado, nombre: @producto.nombre, precio: @producto.precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { cantidad: @producto.cantidad, descripcion: @producto.descripcion, fecha_agregado: @producto.fecha_agregado, nombre: @producto.nombre, precio: @producto.precio } }
