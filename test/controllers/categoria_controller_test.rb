...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { activo: @categorium.activo, descripcion: @categorium.descripcion, fecha_creacion: @categorium.fecha_creacion, nombre: @categorium.nombre, parent_id: @categorium.parent_id } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { activo: @categorium.activo, descripcion: @categorium.descripcion, fecha_creacion: @categorium.fecha_creacion, nombre: @categorium.nombre, parent_id: @categorium.parent_id } }
